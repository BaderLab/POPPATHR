...
hc$theme[ hc$theme==1|hc$theme==5|hc$theme==15|hc$theme==17|hc$theme==18|
          ...
          hc$theme==55|hc$theme==39|hc$theme==41|hc$theme==42|hc$theme==25|
          hc$theme==7|hc$theme==13|hc$theme==52|hc$theme==21 ] = "Immune function"
# lipid metabolism
hc$theme[ hc$theme==34|hc$theme==40|hc$theme==35|hc$theme==6 ] = "Lipid metabolism"
# growth + development
hc$theme[ hc$theme==3|hc$theme==9|hc$theme==10|hc$theme==43|hc$theme==44|
          hc$theme==45|hc$theme==48|hc$theme==50|hc$theme==53|hc$theme==16|
          hc$theme==4|hc$theme==56|hc$theme==47 ] = "Growth & development"
# cell behaviour
hc$theme[ hc$theme==31|hc$theme==32|hc$theme==33|hc$theme==8|hc$theme==2|
          hc$theme==24 ] = "Cell behaviour"

hc$theme[ hc$theme==11|hc$theme==12 ] = "Light & UV response"
hc$theme[ hc$theme==54 ] = "Estrogen receptor"
hc$theme[ hc$theme==14 ] = "DNA regulation"
...
#reorder boxplots by decreasing mean
p2 <- ggplot(both, aes(x=fct_reorder(theme, fst, fun=mean, .desc=TRUE), y=fst)) +
        facet_grid(.~set, scales="free_x", space="free_x") +
        geom_violin(trim=FALSE, aes(fill=set)) +
        geom_boxplot(width=0.1, fill="white") +
        guides(fill=FALSE) +
