...
while(defined(my $line = <BED>)) {
   ...
   # Run bigWigSummary 
   system("/media/catherine/DATAPART1/Data/PopulationPathways/bin/UCSC/bigWigSummary -type=max /media/catherine/DATAPART1/Data/PopulationPathways/data/genomes/mm9_vertebrate_phastCons/bw/$chr.bw $chr $start $end 1 > $$.max_tmp 2>&1");
   system("/media/catherine/DATAPART1/Data/PopulationPathways/bin/UCSC/bigWigSummary -type=mean /media/catherine/DATAPART1/Data/PopulationPathways/data/genomes/mm9_vertebrate_phastCons/bw/$chr.bw $chr $start $end 1 > $$.mean_tmp 2>&1");
